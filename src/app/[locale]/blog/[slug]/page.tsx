...
export default async function Blog({
	...
	return (
		<section id="blog" className="relative max-w-2xl mx-auto px-6 w-full">
			<script
			...
			<h1 className="title font-bold font-serif text-5xl tracking-tighter max-w-[650px]">
				{post.metadata.title}
			</h1>
			...
			<article
				className="prose dark:prose-invert sm:mb-0 mb-12 font-serif"
				// biome-ignore lint/security/noDangerouslySetInnerHtml: <explanation>
